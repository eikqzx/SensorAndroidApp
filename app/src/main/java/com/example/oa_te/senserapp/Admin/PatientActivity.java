...
public class PatientActivity extends AppCompatActivity {
    ...
    Button Finish;
    TextView textViewDevice, textViewDeviceShow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerSex = findViewById(R.id.spinnerSexReg);
    ...
    private void manageptdialog(final String getpatientuid, final String getpatientname){
        ...
        final View dialogView = inflater.inflate(R.layout.manage_patient, null);
        final TextView showname = dialogView.findViewById(R.id.content_managept);
        final Button realtime  = dialogView.findViewById(R.id.realtime_managept);
        final Button delete  = dialogView.findViewById(R.id.delete_managept);
        final Button update = dialogView.findViewById(R.id.promote);
        final Button close  = dialogView.findViewById(R.id.close_managept);
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(PATIENT_UID, getpatientuid);
                startActivity(intent);
                c.dismiss();
            }
        });
    ...
    protected void onStart() {
        ...
        databasePatient.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                PatientList trackListAdapter = new PatientList(PatientActivity.this, patients);
